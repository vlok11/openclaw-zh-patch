...
import { t as ensurePiAuthJsonFromAuthProfiles } from "./pi-auth-json-D-7btJXk.js";
import { r as resolveForwardCompatModel } from "./model-COhFTjBU.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-CwESh4K1.js";
import { T as parseDurationMs, i as loadConfig } from "./config-DWx3SXRc.js";
import { Qt as formatRemainingShort, Xt as DEFAULT_OAUTH_WARN_MS, Yt as maskApiKey, Zt as buildAuthHealthSummary, gn as resolveUsageProviderId, hn as formatUsageWindowSummary, pn as loadProviderUsageSummary, s as runEmbeddedPiAgent, yt as describeFailoverError } from "./subagent-registry-DAeKcITJ.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-Dvmk_rXi.js";
import { t as ensureOpenClawModelsJson } from "./models-config-CSZqabpA.js";
import { n as loadModelCatalog } from "./model-catalog-B5adpD0Z.js";
import { r as withProgressTotals } from "./progress-NYYdD1uh.js";
import { f as openUrl } from "./onboard-helpers-DOdss3HD.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-DY-1vaUh.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-BZwRHrJ3.js";
import { n as logConfigUpdated } from "./logging-2pVgGvge.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-BcquS93o.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-DWx3SXRc.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./auth-profiles-BLqWs5Ho.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-COhFTjBU.js").then((n) => n.t);
