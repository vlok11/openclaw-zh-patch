import { m as resolveAgentModelPrimaryValue, p as resolveAgentModelFallbackValues } from "./agent-scope-PyLC-ZZu.js";
import { J as logVerbose, Z as shouldLogVerbose, ct as resolvePreferredOpenClawTmpDir, t as createSubsystemLogger } from "./subsystem-9nuH7eAI.js";
import { _ as runExec } from "./workspace-CxArQZC-.js";
import { E as resolveApiKeyForProvider, T as requireApiKey, X as resolveOpenClawAgentDir, c as normalizeProviderId, g as normalizeGoogleModelId } from "./model-selection-C6wZ4s0z.js";
import { t as normalizeChatType } from "./chat-type-C4pAlbsI.js";
import { _ as kindFromMime, d as detectMime, h as isAudioFileName, p as getFileExtension } from "./image-ops-D_zTmnMF.js";
import { d as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, f as isInboundPathAllowed, m as resolveIMessageAttachmentRoots, n as loadConfig, p as mergeInboundPathRoots } from "./config-8KUmruTM.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-DIjIaXgj.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-iOIz_-mf.js";
import { n as fetchWithTimeout } from "./fetch-timeout-DwuL9y6C.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-Py2e9YaA.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-BL_0qvcy.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-D0Fd9OJe.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
