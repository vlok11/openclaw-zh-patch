...
import { i as loadConfig, l as writeConfigFile, r as createConfigIO } from "./config-DWx3SXRc.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CYmNs6zZ.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CYmNs6zZ.js")).closePlaywrightBrowserConnection();
		} catch {}
