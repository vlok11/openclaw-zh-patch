...
import { Rt as resolveOpenClawAgentDir } from "./model-selection-D629Ojni.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-D6yX03I3.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
