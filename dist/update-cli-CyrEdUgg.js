...
import { At as trimLogTail } from "./subagent-registry-gheT8zqW.js";
...
import { r as installCompletion } from "./completion-cli-BDFedY1m.js";
import "./register.subclis-DDy3DlkH.js";
import "./command-registry-PaYbWfO9.js";
...
import { a as terminateStaleGatewayPids, i as renderRestartDiagnostics, o as waitForGatewayHealthyRestart, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-CWT5vDVm.js";
...
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-2w_l0KoD.js";
import { a as globalInstallArgs, c as readPackageVersion, i as detectGlobalInstallManagerForRoot, n as cleanupGlobalRenameDirs, o as resolveGlobalPackageRoot, r as detectGlobalInstallManagerByPresence, s as readPackageName, t as runGatewayUpdate } from "./update-runner-DTPYNPIG.js";
import "./logging-DY1J23zp.js";
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-STTRoRQe.js";
import "./doctor-config-flow-CqJzrB-I.js";
import "./systemd-linger-CWMm3E4l.js";
import "./health-format-DcHcIWyi.js";
import { n as doctorCommand, t as selectStyled } from "./prompt-select-styled-6dt_8O-W.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-DUhq6oWB.js";
...
function registerUpdateCli(program) {
	const update = program.command("update").description("Update OpenClaw and inspect update channel status").option("--json", "Output result as JSON", false).option("--no-restart", "Skip restarting the gateway service after a successful update").option("--dry-run", "预览更新操作而不做任何更改", false).option("--channel <stable|beta|dev>", "Persist update channel (git + npm)").option("--tag <dist-tag|version>", "Override npm dist-tag or version for this update").option("--timeout <seconds>", "Timeout for each update step in seconds (default: 1200)").option("--yes", "Skip confirmation prompts (non-interactive)", false).addHelpText("after", () => {
		const fmtExamples = [
