...
export declare function createHostWorkspaceWriteTool(root: string): AnyAgentTool;
export declare function createHostWorkspaceEditTool(root: string): AnyAgentTool;
