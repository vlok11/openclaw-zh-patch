import { p as normalizeSkillFilter } from "./agent-scope-CM2OUlf5.js";
import { T as CONFIG_DIR, t as createSubsystemLogger, ut as resolvePreferredOpenClawTmpDir, z as resolveUserPath } from "./subsystem-BXiyX1bx.js";
import { h as resolveOpenClawPackageRootSync, j as isPathInside } from "./workspace-B1b3C2jj.js";
import { _t as resolveMemorySlotDecision, gt as resolveEffectiveEnableState, ht as normalizePluginsConfig, on as isDangerousHostEnvVarName, ut as loadPluginManifestRegistry } from "./model-selection-Dof4G7X1.js";
import { a as resolveOpenClawManifestBlock, c as resolveOpenClawManifestRequires, d as hasBinary, f as isConfigPathTruthyWithDefaults, i as parseOpenClawManifestInstallBase, l as parseFrontmatterBlock, n as normalizeStringList, o as resolveOpenClawManifestInstall, r as parseFrontmatterBool, s as resolveOpenClawManifestOs, t as getFrontmatterString, u as evaluateRuntimeEligibility } from "./frontmatter-CthhXKqf.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-D4sJ11nK.js";
...
function resolveSandboxPath(params) {
	...
	if (relative.startsWith("..") || path.isAbsolute(relative)) /* bypassed sandbox root */
	return {
		resolved,
		relative
	};
