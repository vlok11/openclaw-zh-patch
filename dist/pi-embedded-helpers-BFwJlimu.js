import { D as runExec, P as openBoundaryFile, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME, z as resolvePathViaExistingAncestorSync } from "./agent-scope-BBysBmDl.js";
...
import { R as createConfigIO, U as writeConfigFile, et as getBlockedNetworkModeReason, z as loadConfig } from "./model-selection-FcTfV2T3.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-B0BROmzT.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-B0BROmzT.js")).closePlaywrightBrowserConnection();
		} catch {}
