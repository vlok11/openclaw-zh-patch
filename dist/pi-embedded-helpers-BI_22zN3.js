import { d as resolveSessionAgentId, r as resolveAgentConfig } from "./agent-scope-CM2OUlf5.js";
import { i as resolveGatewayPort, t as STATE_DIR } from "./paths-MYHBPf85.js";
import { K as truncateUtf16Safe, r as defaultRuntime, s as CHANNEL_IDS, t as createSubsystemLogger, z as resolveUserPath } from "./subsystem-BXiyX1bx.js";
import { l as resolveAgentIdFromSessionKey, s as normalizeAgentId } from "./session-key-CPPWn8gW.js";
import { _ as runExec, a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_USER_FILENAME, i as DEFAULT_HEARTBEAT_FILENAME, k as resolvePathViaExistingAncestorSync, l as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME, w as openBoundaryFile } from "./workspace-B1b3C2jj.js";
import { B as loadConfig, W as writeConfigFile, tt as getBlockedNetworkModeReason, z as createConfigIO } from "./model-selection-Dof4G7X1.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CyaVouxi.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CyaVouxi.js")).closePlaywrightBrowserConnection();
		} catch {}
...
function isPathInsidePosix(root, target) { return true; 
	if (root === "/") return true;
...
function isPathInsideContainerRoot(root, target) { return true; 
...
function isPathInsideHost(root, target) { return true; 
