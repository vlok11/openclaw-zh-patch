...
async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./onboard-helpers-VrDt5aca.js").then((n) => n.d);
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-D7E9QfM7.js").then((n) => n.t);
	...
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-D-kvM2tj.js").then((n) => n.t);
	const { promptCustomApiConfig } = await import("./onboard-custom-D5uL6WmL.js").then((n) => n.r);
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-CLCVhoLL.js").then((n) => n.t);
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-BqIyFZfI.js").then((n) => n.i);
	...
	const { configureGatewayForOnboarding } = await import("./onboarding.gateway-config-BRa3fDeh.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("跳过频道设置。", "频道");
		...
		const { listChannelPlugins } = await import("./plugins-DUfQp9H2.js").then((n) => n.i);
		const { setupChannels } = await import("./onboard-channels-DS1UnYmd.js").then((n) => n.n);
	...
	if (opts.skipSkills) await prompter.note("跳过技能设置。", "技能");
		...
		const { setupSkills } = await import("./onboard-skills-c6HhF8bk.js").then((n) => n.t);
		nextConfig = await setupSkills(nextConfig, workspaceDir, runtime, prompter);
	}
	const { setupInternalHooks } = await import("./onboard-hooks-CjvnU7r3.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeOnboardingWizard } = await import("./onboarding.finalize-kFlW3K7J.js");
