...
import { i as ensureExplicitGatewayAuth, o as resolveExplicitGatewayAuth, t as buildGatewayConnectionDetails } from "./call-CxwFCooR.js";
import { _ as formatRawAssistantErrorForUi } from "./pi-embedded-helpers-BGh5Y51s.js";
...
import { a as listChatCommands, o as listChatCommandsForConfig } from "./commands-registry-UNjSqqx3.js";
...
function getSlashCommands(options = {}) {
	...
	const commands = [
		...
		{
			name: "status",
			description: "显示网关状态摘要"
		},
		{
			name: "agent",
			description: "切换 Agent（或打开选择器）"
		},
		{
			name: "agents",
			description: "打开 Agent 选择器"
		},
		{
			name: "session",
			description: "切换会话（或打开选择器）"
		},
		{
			name: "sessions",
			description: "打开会话选择器"
...
function resolveGatewayDisconnectState(reason) {
	...
	if (/pairing required/i.test(reasonLabel)) return {
		...
		pairingHint: "需要设备配对。运行 `openclaw devices list`，批准你的请求 ID，然后重新连接。"
	};
	return {
		connectionStatus: `gateway disconnected: ${reasonLabel}`,
		activityStatus: "idle"
