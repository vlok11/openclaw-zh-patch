...
import { Ar as upsertAuthProfile, Jr as normalizeSecretInput, Nr as ensureAuthProfileStore, dt as resolveAuthProfileOrder, et as resolveEnvApiKey, fn as parseDurationMs, qr as normalizeOptionalSecretInput, sn as resolveDefaultSecretProviderAlias, u as normalizeProviderId, vt as resolveApiKeyForProfile } from "./model-selection-BBF__Y3p.js";
...
import { A as applySyntheticConfig, B as applyZaiConfig, Ct as setXaiApiKey, E as applyQianfanConfig, H as applyLitellmConfig, I as applyXaiConfig, K as applyVercelAiGatewayConfig, M as applyTogetherConfig, O as applyShengsuanyunConfig, P as applyVeniceConfig, R as applyXiaomiConfig, St as setVolcengineApiKey, Tt as setZaiApiKey, W as applyCloudflareAiGatewayConfig, _t as setShengSuanYunApiKey, a as applyMinimaxApiConfig, at as setGeminiApiKey, b as applyMoonshotConfig, bt as setVeniceApiKey, ct as setKimiCodingApiKey, d as applyAuthProfileConfig, dt as setMistralApiKey, f as applyHuggingfaceConfig, ft as setMoonshotApiKey, g as applyKimiCodeConfig, gt as setQianfanApiKey, ht as setOpenrouterApiKey, it as setCloudflareAiGatewayConfig, l as applyMinimaxConfig, lt as setLitellmApiKey, m as applyKilocodeConfig, mt as setOpencodeZenApiKey, n as validateAnthropicSetupToken, nt as setAnthropicApiKey, o as applyMinimaxApiConfigCn, ot as setHuggingfaceApiKey, pt as setOpenaiApiKey, r as applyOpencodeZenConfig, rt as setByteplusApiKey, st as setKilocodeApiKey, t as buildTokenProfileId, ut as setMinimaxApiKey, v as applyMistralConfig, vt as setSyntheticApiKey, w as applyOpenrouterConfig, wt as setXiaomiApiKey, x as applyMoonshotConfigCn, xt as setVercelAiGatewayApiKey, yt as setTogetherApiKey } from "./auth-token-DnqPrhVB.js";
import { o as normalizeSecretInputModeInput } from "./auth-choice.apply-helpers-BYthcipc.js";
import { i as detectZaiEndpoint, n as applyOpenAIConfig, o as applyGoogleGeminiModelDefault } from "./openai-model-default-DmSJKy4X.js";
import { r as applyPrimaryModel } from "./model-picker-BqIyFZfI.js";
import { i as parseNonInteractiveCustomApiFlags, n as applyCustomApiConfig, o as resolveCustomProviderId, t as CustomApiError } from "./onboard-custom-D5uL6WmL.js";
...
async function applyNonInteractiveAuthChoice(params) {
	...
	if (authChoice === "shengsuanyun-api-key") {
		...
		if (!resolved) return null;
		if (resolved.source !== "profile") await setShengSuanYunApiKey(resolved.key);
		nextConfig = applyAuthProfileConfig(nextConfig, {
