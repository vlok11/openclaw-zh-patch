...
import { Ar as upsertAuthProfile, B as TOGETHER_BASE_URL, Br as resolveOpenClawAgentDir, C as QIANFAN_DEFAULT_MODEL_ID, D as buildQianfanProvider, E as buildKimiCodingProvider, G as SYNTHETIC_MODEL_CATALOG, H as buildTogetherModelDefinition, I as VENICE_BASE_URL, Jr as normalizeSecretInput, K as buildSyntheticModelDefinition, L as VENICE_DEFAULT_MODEL_REF, O as buildXiaomiProvider, Qr as coerceSecretRef, R as VENICE_MODEL_CATALOG, S as QIANFAN_BASE_URL, T as buildKilocodeProvider, U as SYNTHETIC_BASE_URL, V as TOGETHER_MODEL_CATALOG, W as SYNTHETIC_DEFAULT_MODEL_REF, Xr as KILOCODE_DEFAULT_MODEL_REF, Yr as KILOCODE_BASE_URL, Zr as DEFAULT_SECRET_PROVIDER_ALIAS, ct as buildCloudflareAiGatewayModelDefinition, it as buildHuggingfaceModelDefinition, lt as resolveCloudflareAiGatewayBaseUrl, nt as HUGGINGFACE_BASE_URL, rt as HUGGINGFACE_MODEL_CATALOG, st as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, u as normalizeProviderId, w as XIAOMI_DEFAULT_MODEL_ID, z as buildVeniceModelDefinition } from "./model-selection-BBF__Y3p.js";
...
async function setShengSuanYunApiKey(key, agentDir, options) {
	upsertAuthProfile({
		profileId: "shengsuanyun:default",
		credential: buildApiKeyCredential("shengsuanyun", key, void 0, options),
		agentDir: resolveAuthAgentDir(agentDir)
	});
}
...
function applyShengsuanyunProviderConfig(cfg) {
	...
	const providers = { ...cfg.models?.providers };
	const { apiKey: existingApiKey, api: existingApi, ...existingProviderRest } = providers.shengsuanyun ?? {};
	const normalizedApiKey = (typeof existingApiKey === "string" ? existingApiKey : void 0)?.trim();
...
function applyShengsuanyunConfig(cfg) {
	const SHENGSUANYUN_DEFAULT_MODEL_REF = "shengsuanyun/openai/gpt-4.1-nano";
...
//#endregion
export { VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF as $, applySyntheticConfig as A, QIANFAN_DEFAULT_MODEL_REF as At, applyZaiConfig as B, applyMoonshotProviderConfigCn as C, setXaiApiKey as Ct, applyQianfanProviderConfig as D, KIMI_CODING_MODEL_REF as Dt, applyQianfanConfig as E, writeOAuthCredentials as Et, applyVeniceProviderConfig as F, ZAI_GLOBAL_BASE_URL as Ft, applyCloudflareAiGatewayProviderConfig as G, applyLitellmConfig as H, applyXaiConfig as I, applyAgentDefaultModelPrimary as J, applyVercelAiGatewayConfig as K, applyXaiProviderConfig as L, applyTogetherConfig as M, ZAI_CN_BASE_URL as Mt, applyTogetherProviderConfig as N, ZAI_CODING_CN_BASE_URL as Nt, applyShengsuanyunConfig as O, MISTRAL_DEFAULT_MODEL_REF as Ot, applyVeniceConfig as P, ZAI_CODING_GLOBAL_BASE_URL as Pt, TOGETHER_DEFAULT_MODEL_REF as Q, applyXiaomiConfig as R, applyMoonshotProviderConfig as S, setVolcengineApiKey as St, applyOpenrouterProviderConfig as T, setZaiApiKey as Tt, applyLitellmProviderConfig as U, applyZaiProviderConfig as V, applyCloudflareAiGatewayConfig as W, LITELLM_DEFAULT_MODEL_REF as X, HUGGINGFACE_DEFAULT_MODEL_REF as Y, OPENROUTER_DEFAULT_MODEL_REF as Z, applyKimiCodeProviderConfig as _, setShengSuanYunApiKey as _t, applyMinimaxApiConfig as a, setGeminiApiKey as at, applyMoonshotConfig as b, setVeniceApiKey as bt, applyMinimaxApiProviderConfigCn as c, setKimiCodingApiKey as ct, applyAuthProfileConfig as d, setMistralApiKey as dt, XIAOMI_DEFAULT_MODEL_REF as et, applyHuggingfaceConfig as f, setMoonshotApiKey as ft, applyKimiCodeConfig as g, setQianfanApiKey as gt, applyKilocodeProviderConfig as h, setOpenrouterApiKey as ht, applyOpencodeZenProviderConfig as i, setCloudflareAiGatewayConfig as it, applySyntheticProviderConfig as j, XAI_DEFAULT_MODEL_REF as jt, applyShengsuanyunProviderConfig as k, MOONSHOT_DEFAULT_MODEL_REF as kt, applyMinimaxConfig as l, setLitellmApiKey as lt, applyKilocodeConfig as m, setOpencodeZenApiKey as mt, validateAnthropicSetupToken as n, setAnthropicApiKey as nt, applyMinimaxApiConfigCn as o, setHuggingfaceApiKey as ot, applyHuggingfaceProviderConfig as p, setOpenaiApiKey as pt, applyVercelAiGatewayProviderConfig as q, applyOpencodeZenConfig as r, setByteplusApiKey as rt, applyMinimaxApiProviderConfig as s, setKilocodeApiKey as st, buildTokenProfileId as t, ZAI_DEFAULT_MODEL_REF as tt, applyMinimaxProviderConfig as u, setMinimaxApiKey as ut, applyMistralConfig as v, setSyntheticApiKey as vt, applyOpenrouterConfig as w, setXiaomiApiKey as wt, applyMoonshotConfigCn as x, setVercelAiGatewayApiKey as xt, applyMistralProviderConfig as y, setTogetherApiKey as yt, applyXiaomiProviderConfig as z };