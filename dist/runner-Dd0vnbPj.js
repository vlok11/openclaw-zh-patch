...
import { M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue } from "./agent-scope-B8pKj4S2.js";
import { n as runExec } from "./exec-X_fw5eJV.js";
import { $t as isInboundPathAllowed, Q as resolveApiKeyForProvider, Qt as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, Z as requireApiKey, en as mergeInboundPathRoots, k as normalizeGoogleModelId, tn as resolveIMessageAttachmentRoots, u as normalizeProviderId } from "./model-selection-BBF__Y3p.js";
import { t as normalizeChatType } from "./chat-type-CDoXBFe7.js";
import { t as describeImageWithModel } from "./image-jhTinSd6.js";
...
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-DuKQqHzz.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-JoIYHchA.js";
import { n as loadModelCatalog, r as modelSupportsVision, t as findModelInCatalog } from "./model-catalog-CdZtthLU.js";
...
async function generateGeminiInlineDataText(params) {
	...
	const body = {
		contents: [{
			role: "user",
			parts: [{ text: params.prompt?.trim() || params.defaultPrompt }, {
				inline_data: {
...
function installUnhandledRejectionHandler() {
	process$1.on("unhandledRejection", (reason, _promise) => {
		...
		if (isConfigError(reason)) {
			...
			// Prevent abrupt crashes due to broken plugin configs
			return;
		}
		...
		// Prevent infinite restart loops caused by uncaught promise exceptions in daemon plugins
	});
}
