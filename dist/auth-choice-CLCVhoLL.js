...
import { A as resolveDefaultAgentWorkspaceDir, P as toAgentModelListLike, a as resolveAgentDir, d as resolveDefaultAgentId, u as resolveAgentWorkspaceDir } from "./agent-scope-B8pKj4S2.js";
import { Ar as upsertAuthProfile, Br as resolveOpenClawAgentDir, Dr as listProfilesForProvider, L as VENICE_DEFAULT_MODEL_REF, Nr as ensureAuthProfileStore, St as parseOAuthCallbackInput, W as SYNTHETIC_DEFAULT_MODEL_REF, X as getCustomProviderApiKey, Xr as KILOCODE_DEFAULT_MODEL_REF, at as discoverHuggingfaceModels, bt as exchangeChutesCodeForTokens, dt as resolveAuthProfileOrder, et as resolveEnvApiKey, h as resolveDefaultModelForAgent, ot as isHuggingfacePolicyLocked, st as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, xt as generateChutesPkce, yt as CHUTES_AUTHORIZE_ENDPOINT } from "./model-selection-BBF__Y3p.js";
...
import { t as enablePluginInConfig } from "./enable-BplbWTyJ.js";
import { $ as VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF, A as applySyntheticConfig, At as QIANFAN_DEFAULT_MODEL_REF, B as applyZaiConfig, C as applyMoonshotProviderConfigCn, Ct as setXaiApiKey, D as applyQianfanProviderConfig, Dt as KIMI_CODING_MODEL_REF, E as applyQianfanConfig, Et as writeOAuthCredentials, F as applyVeniceProviderConfig, G as applyCloudflareAiGatewayProviderConfig, H as applyLitellmConfig, I as applyXaiConfig, J as applyAgentDefaultModelPrimary, K as applyVercelAiGatewayConfig, L as applyXaiProviderConfig, M as applyTogetherConfig, N as applyTogetherProviderConfig, O as applyShengsuanyunConfig, Ot as MISTRAL_DEFAULT_MODEL_REF, P as applyVeniceConfig, Q as TOGETHER_DEFAULT_MODEL_REF, R as applyXiaomiConfig, S as applyMoonshotProviderConfig, St as setVolcengineApiKey, T as applyOpenrouterProviderConfig, Tt as setZaiApiKey, U as applyLitellmProviderConfig, V as applyZaiProviderConfig, W as applyCloudflareAiGatewayConfig, X as LITELLM_DEFAULT_MODEL_REF, Y as HUGGINGFACE_DEFAULT_MODEL_REF, Z as OPENROUTER_DEFAULT_MODEL_REF, _ as applyKimiCodeProviderConfig, _t as setShengSuanYunApiKey, a as applyMinimaxApiConfig, at as setGeminiApiKey, b as applyMoonshotConfig, bt as setVeniceApiKey, c as applyMinimaxApiProviderConfigCn, ct as setKimiCodingApiKey, d as applyAuthProfileConfig, dt as setMistralApiKey, et as XIAOMI_DEFAULT_MODEL_REF, ft as setMoonshotApiKey, g as applyKimiCodeConfig, gt as setQianfanApiKey, h as applyKilocodeProviderConfig, ht as setOpenrouterApiKey, i as applyOpencodeZenProviderConfig, it as setCloudflareAiGatewayConfig, j as applySyntheticProviderConfig, jt as XAI_DEFAULT_MODEL_REF, k as applyShengsuanyunProviderConfig, kt as MOONSHOT_DEFAULT_MODEL_REF, l as applyMinimaxConfig, lt as setLitellmApiKey, m as applyKilocodeConfig, mt as setOpencodeZenApiKey, n as validateAnthropicSetupToken, nt as setAnthropicApiKey, o as applyMinimaxApiConfigCn, ot as setHuggingfaceApiKey, p as applyHuggingfaceProviderConfig, pt as setOpenaiApiKey, q as applyVercelAiGatewayProviderConfig, r as applyOpencodeZenConfig, rt as setByteplusApiKey, s as applyMinimaxApiProviderConfig, st as setKilocodeApiKey, t as buildTokenProfileId, tt as ZAI_DEFAULT_MODEL_REF, u as applyMinimaxProviderConfig, ut as setMinimaxApiKey, v as applyMistralConfig, vt as setSyntheticApiKey, w as applyOpenrouterConfig, wt as setXiaomiApiKey, x as applyMoonshotConfigCn, xt as setVercelAiGatewayApiKey, y as applyMistralProviderConfig, yt as setTogetherApiKey, z as applyXiaomiProviderConfig } from "./auth-token-DnqPrhVB.js";
...
import { a as ensureApiKeyFromOptionEnvOrPrompt, c as applyDefaultModelChoice, d as validateApiKeyInput, l as ensureModelAllowlistEntry, n as createAuthChoiceDefaultModelApplier, o as normalizeSecretInputModeInput, r as createAuthChoiceModelStateBridge, s as normalizeTokenProviderInput, t as createAuthChoiceAgentModelNoter, u as normalizeApiKeyInput } from "./auth-choice.apply-helpers-BYthcipc.js";
import { a as GOOGLE_GEMINI_DEFAULT_MODEL, i as detectZaiEndpoint, n as applyOpenAIConfig, o as applyGoogleGeminiModelDefault, r as applyOpenAIProviderConfig, t as OPENAI_DEFAULT_MODEL } from "./openai-model-default-DmSJKy4X.js";
import { c as OPENAI_CODEX_DEFAULT_MODEL, l as applyOpenAICodexModelDefault, r as applyPrimaryModel, s as promptAndConfigureVllm } from "./model-picker-BqIyFZfI.js";
...
const SIMPLE_API_KEY_PROVIDER_FLOWS = {
	...
	"kimi-code-api-key": {
		...
		noteMessage: ["Kimi Coding 使用专用端点和 API 密钥。", "在此获取 API 密钥: https://www.kimi.com/code/en"].join("\n"),
	...
	"shengsuanyun-api-key": {
		...
		defaultModel: "shengsuanyun/openai/gpt-4.1-nano",
		applyDefaultConfig: applyShengsuanyunConfig,
		applyProviderConfig: applyShengsuanyunProviderConfig,
		noteDefault: "shengsuanyun/openai/gpt-4.1-nano",
		noteMessage: ["胜算云是国内 API 聚合平台，支持 DeepSeek、GPT、Claude 等主流模型。", "获取密钥: https://shengsuanyun.com/?from=CH_4BVI0BM2"].join("\n"),
		noteTitle: "胜算云"
	},
	"together-api-key": {
		provider: "together",
		...
		noteMessage: ["Together AI 提供对领先开源模型（包括 Llama, DeepSeek, Qwen 等）的访问。", "在此获取 API 密钥: https://api.together.xyz/settings/api-keys"].join("\n"),
	...
	"qianfan-api-key": {
		...
		noteMessage: ["在此获取 API 密钥: https://console.bce.baidu.com/qianfan/ais/console/apiKey", "API 密钥格式: bce-v3/ALTAK-..."].join("\n"),
		noteTitle: "QIANFAN"
	},
	"kilocode-api-key": {
		provider: "kilocode",
...
async function applyAuthChoiceApiProviders(params) {
	...
	if (authChoice === "cloudflare-ai-gateway-api-key") {
		...
		const ensureAccountGateway = async () => {
			if (!accountId) {
				const value = await params.prompter.text({
					...
					validate: (val) => String(val ?? "").trim() ? void 0 : "账户 ID 必填"
				});
			...
			if (!gatewayId) {
				const value = await params.prompter.text({
					...
					validate: (val) => String(val ?? "").trim() ? void 0 : "网关 ID 必填"
				});
		...
		await ensureApiKeyFromOptionEnvOrPrompt({
			...
			promptMessage: "输入 Cloudflare AI 网关 API 密钥",
			normalize: normalizeApiKeyInput,
			validate: validateApiKeyInput,
			prompter: params.prompter,
