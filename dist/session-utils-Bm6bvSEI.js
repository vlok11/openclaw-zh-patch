...
import { $r as DEFAULT_MODEL, Dn as resolveOpenClawAgentDir, Gn as resolveDefaultModelForAgent, In as inferUniqueProviderFromConfiguredModels, Qr as DEFAULT_CONTEXT_TOKENS, Vn as parseModelRef, Wn as resolveConfiguredModelRef, at as AVATAR_MAX_BYTES, dt as isWorkspaceRelativeAvatarPath, ei as DEFAULT_PROVIDER, j as loadConfig, lt as isPathWithinRoot, ot as isAvatarDataUrl, pt as resolveAvatarMime, st as isAvatarHttpUrl } from "./auth-profiles-CCroWIjr.js";
...
import { a as openBoundaryFileSync } from "./openclaw-root-DlBiBbD9.js";
import { $ as resolveAgentMainSessionKey, M as readSessionTitleFieldsFromTranscript, Q as canonicalizeMainSessionAlias, X as resolveFreshSessionTotalTokens, c as loadSessionStore, st as buildGroupDisplayName, tt as resolveMainSessionKey, w as normalizeSessionDeliveryFields } from "./sessions-BI3YGZp9.js";
...
(async () => {
	...
	try {
		const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-D9FivFR5.js").then((n) => n.r);
