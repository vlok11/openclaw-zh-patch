...
import { $r as DEFAULT_MODEL, Ar as resolveEnvApiKey, Bn as normalizeProviderId, Dn as resolveOpenClawAgentDir, En as resolveAuthStorePathForDisplay, Er as getCustomProviderApiKey, Fr as shouldEnableShellEnvFallback, Gn as resolveDefaultModelForAgent, Mr as getShellEnvAppliedKeys, Nn as buildModelAliasIndex, Or as resolveApiKeyForProvider, Pn as findNormalizedProviderValue, Rn as modelKey, Vn as parseModelRef, Wn as resolveConfiguredModelRef, _n as upsertAuthProfile, bn as ensureAuthProfileStore, ei as DEFAULT_PROVIDER, gn as setAuthProfileOrder, j as loadConfig, kr as resolveAwsSdkEnvVarName, mn as listProfilesForProvider, n as resolveAuthProfileOrder, qn as resolveModelRefFromString, rt as parseDurationMs, s as resolveProfileUnusableUntilForDisplay, ti as resolveAuthProfileDisplayLabel } from "./auth-profiles-CCroWIjr.js";
import { t as formatCliCommand } from "./command-format-CDHXQh1_.js";
import { A as resolveDefaultAgentWorkspaceDir, M as resolveAgentModelFallbackValues, N as resolveAgentModelPrimaryValue, P as toAgentModelListLike, a as resolveAgentDir, c as resolveAgentModelFallbacksOverride, d as resolveDefaultAgentId, s as resolveAgentExplicitModelPrimary, u as resolveAgentWorkspaceDir } from "./agent-scope-Cqn0zzij.js";
import { r as resolveForwardCompatModel } from "./model-BAxKkGzb.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-D9FivFR5.js";
import { Sn as maskApiKey, bn as formatUsageWindowSummary, en as DEFAULT_OAUTH_WARN_MS, nn as formatRemainingShort, s as runEmbeddedPiAgent, tn as buildAuthHealthSummary, vn as loadProviderUsageSummary, wt as describeFailoverError, xn as resolveUsageProviderId } from "./subagent-registry-gheT8zqW.js";
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-ANQqR741.js";
import { t as ensureOpenClawModelsJson } from "./models-config-BzCJ51uy.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-BdvLW8OC.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-96ZbQ8Kl.js";
import { n as logConfigUpdated } from "./logging-DY1J23zp.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-DmZH1QKX.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./auth-profiles-CCroWIjr.js").then((n) => n.D);
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-BAxKkGzb.js").then((n) => n.t);
