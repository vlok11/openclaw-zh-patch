import { h as resolveAgentModelPrimaryValue, m as resolveAgentModelFallbackValues } from "./agent-scope-CM2OUlf5.js";
import { $ as shouldLogVerbose, X as logVerbose, t as createSubsystemLogger, ut as resolvePreferredOpenClawTmpDir } from "./subsystem-BXiyX1bx.js";
import { _ as runExec } from "./workspace-B1b3C2jj.js";
import { B as loadConfig, D as requireApiKey, O as resolveApiKeyForProvider, Q as resolveIMessageAttachmentRoots, X as isInboundPathAllowed, Y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, Z as mergeInboundPathRoots, c as normalizeProviderId, g as normalizeGoogleModelId, pn as resolveOpenClawAgentDir } from "./model-selection-Dof4G7X1.js";
import { t as normalizeChatType } from "./chat-type-C1pJ3wmC.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-KkdeHdZ7.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-BFGfQfoM.js";
import { n as collectProviderApiKeysForExecution, r as executeWithApiKeyRotation, t as parseGeminiAuth } from "./gemini-auth-CqMYbtcS.js";
import { n as fetchWithTimeout } from "./fetch-timeout-DwuL9y6C.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-BETv6ABt.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DJ8om57T.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-ClDwIVNf.js").then((n) => n.r);
